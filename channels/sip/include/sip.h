...
#define SIP_PAGE3_SRTP_TRY               (1 << 3)  /*!< DP: Attempt SRTP / do not enforce it */

#define SIP_PAGE3_FLAGS_TO_COPY \
	(SIP_PAGE3_SNOM_AOC | SIP_PAGE3_SRTP_TAG_32 | SIP_PAGE3_DIRECT_MEDIA_OUTGOING | SIP_PAGE3_SRTP_TRY)
